...
PHP
#define( 'WP_REDIS_PASSWORD', 'eYVX7EwVmmxKPCDmwMtyKVge8oLd2t8');

wp core install --url="$DOMAIN_NAME/wordpress" --title="nprljic" --admin_user=$WP_ADMIN_USERNAME --admin_password=$WP_ADMIN_PW --admin_email=$WP_ADMIN_EMAIL --allow-root
